...
class HeightMeasureScreen extends StatefulWidget {
  const HeightMeasureScreen({super.key});

  @override
  HeightMeasureScreenState createState() => HeightMeasureScreenState();
}

class HeightMeasureScreenState extends State<HeightMeasureScreen> {
  double _height = 0.0;
